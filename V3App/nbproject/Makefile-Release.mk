...
${OBJECTDIR}/SOURCE/CPT.o: SOURCE/CPT.c
	...
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/CPT.o SOURCE/CPT.c

${OBJECTDIR}/SOURCE/Display.o: SOURCE/Display.c
	${MKDIR} -p ${OBJECTDIR}/SOURCE
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/Display.o SOURCE/Display.c

${OBJECTDIR}/SOURCE/Ethernet.o: SOURCE/Ethernet.c
	${MKDIR} -p ${OBJECTDIR}/SOURCE
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/Ethernet.o SOURCE/Ethernet.c

${OBJECTDIR}/SOURCE/File.o: SOURCE/File.c
	${MKDIR} -p ${OBJECTDIR}/SOURCE
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/File.o SOURCE/File.c
