...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/App/V3App.exe

dist/V3/App/V3App.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/App
	arm-brcm-linux-gnueabi-g++ -o dist/V3/App/V3App ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}"
...
${OBJECTDIR}/SOURCE/DISPLAY/DisTouch.o: SOURCE/DISPLAY/DisTouch.c
	...
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/DISPLAY/DisTouch.o SOURCE/DISPLAY/DisTouch.c
...
${OBJECTDIR}/SOURCE/FUNCTION/ECR.o: SOURCE/FUNCTION/ECR.c
	${MKDIR} -p ${OBJECTDIR}/SOURCE/FUNCTION
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/FUNCTION/ECR.o SOURCE/FUNCTION/ECR.c

${OBJECTDIR}/SOURCE/FUNCTION/File.o: SOURCE/FUNCTION/File.c
	${MKDIR} -p ${OBJECTDIR}/SOURCE/FUNCTION
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/FUNCTION/File.o SOURCE/FUNCTION/File.c

${OBJECTDIR}/SOURCE/FUNCTION/Function.o: SOURCE/FUNCTION/Function.c
	${MKDIR} -p ${OBJECTDIR}/SOURCE/FUNCTION
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/SOURCE/FUNCTION/Function.o SOURCE/FUNCTION/Function.c
